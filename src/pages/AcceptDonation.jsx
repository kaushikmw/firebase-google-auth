            ...
            <form className={formClass} onSubmit={handleSubmit(acceptDonation)}>
                ...
                <div className="row">
                    ...
                    <label className='m-2'>PAN:</label>
                        <input type="input" className="form-control mr-2  p-2" ref={register()}
                        readOnly name="pan" />
                    </div>
                </div>
                ...
                <label className='d-flex'><h4>Donation Details:</h4></label>
                <div className="row mb-3">
                    <div className='col'>
                        ...
                        ref={register({
                            ...
                            min: {
                                value: 1,
                                message: "Minimum donation amount should be more than zero"
                            },
                            validate: {
                                cashValidation : value =>  donationMode === 'Cash' ? value < 2001 : true
                            }
                          })}/>
                          {errors.amount?.type === "cashValidation" && <p className="text-danger">You cannot accept more than Rs 2000 as cash</p>}
                          <ErrorMessage
                            errors={errors}
                            name="amount"
                    ...
                    <div className='col'>
                        <label className='m-2'>Donation Date:</label>
                    ...
                    <div className='col'>
                        ...
                        <div className='row'>
                            ...
                            <div className='col'>
                                ...
                                <input type="radio" id="Cash" name="mode" value="Cash" ref={register({
                                        required: "Please select donation mode"
                                    })}
                                    onChange={handleModeChange}
                ...
                <div className='row mb-3'>                    
                    ...
                    <div className="col">
                        ...
                        {
                            donorRefError  && (
                                <div className="text-danger">Please select a reference for the donation</div>
                            )
                        }
                    </div>
                </div>
        ...
        return (
            <>
                <div className='list-group-item d-flex list-group-item-info' >
                    ...
                    } key={donorRef.donorId}>{donorRef.fullName}</button>
                </div>
            </>
        );
    });
